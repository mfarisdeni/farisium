...
const content = {
  id: {
    ...
    successDesc:
      'Pesanan F-Stream Boost-mu telah diterima. AI agent akan menganalisis lagumu dan mulai memproses pitch playlist serta kampanye iklan.',
    ...
    paySuccessDesc: 'Kampanye akan segera diproses oleh AI agent Farisium.',
  ...
  en: {
    ...
    successDesc:
      'Your F-Stream Boost order has been received. The AI agent will analyze your track and start processing playlist pitching and the ad campaign.',
    ...
    paySuccessDesc: 'Your campaign will be processed by the Farisium AI agent shortly.',
    payExpired: 'Expired',
